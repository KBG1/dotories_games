...
export default function ArithmeticGame() {
  ...
  // 문제 생성
  const generateQuestion = (diff: Difficulty, prevAns: number | null): Question => {
    let text = ''
    let answer = 0
  ...
  // 다음 문제
  const nextQuestion = (diff: Difficulty, prevAns: number | null, currentNum: number) => {
  ...
  const handleAnswerSelect = (answer: number) => {
    ...
    const nextPrevAnswer = difficulty === 'hard' && currentQuestion 
        ...
        <div className="max-w-md mx-auto p-4">
          ...
          <div className="bg-white rounded-3xl p-6 mb-6 shadow-sm border border-gray-200">
            ...
            <div className="mt-6">
              ...
              <div className="mt-6">
                <button
                  onClick={() => startGameWithDifficulty(selectedDifficulty as Difficulty)}
      ...
      >
        <div className="bg-white p-8 rounded-2xl shadow-2xl text-center max-w-md w-full">
          ...
          <p className="text-lg mb-6 text-gray-600">
            총 {MAX_QUESTIONS}문제 중 <span className="text-blue-600 font-bold">{score}문제</span>를 맞혔습니다!
          </p>
          <p className="text-lg mb-8 text-gray-600">
            정답률: <span className="text-green-600 font-bold">{Math.round((score / MAX_QUESTIONS) * 100)}%</span>
          </p>
          <div className="space-y-3">
            <button
      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="mb-6 bg-white rounded-2xl p-4 shadow-sm">
          <div className="flex justify-between items-center">
            <span className="text-gray-600 font-semibold">문제</span>
